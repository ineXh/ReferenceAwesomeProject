...
// Button size 75
// Snaps at 75 (swipe row right), 0 and -150 (swipe left)
// Icon (Trash, Clock) opacity, fully visible at -150
// Icon (Trash, Clock) scale, fully sized at -150
class Row extends Component {
    ...
    return (
      <View style={{backgroundColor: '#de6d77'}}>
        ...
        <Interactable.View
          horizontalOnly={true}
          snapPoints={[
            {x: 75, id: 'Right', damping: 1-this.props.damping, tension: this.props.tension},
            {x: 0,  id: 'Center', damping: 1-this.props.damping, tension: this.props.tension},
            {x: -150, id: 'Left', damping: 1-this.props.damping, tension: this.props.tension}
          ]}
          onSnap={this.onRowSnap}
          dragToss={0.01}
  ...
  onRowSnap(event) {
    ...
    //console.log(snapPointId);
    alert('Snap state: ' + snapPointId );
  }
}
