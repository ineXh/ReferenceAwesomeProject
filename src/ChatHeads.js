...
const heightFactor = (Dimensions.get('window').height - 60) / 667; //75
...
export default class ChatHeads extends Component {
  ...
  // x: 0, y: 200*heightFactor, scale to 0
  // x: 0, y: 0 is center of phone
  // delete head translateY 
  // 1. low when sliding on top,
  // 2. up slightly when sliding past bottom half of screen
  // 3. down slight when sliding towards bottom of screen
  render() {
    return (
        ...
        <View style={styles.frame} pointerEvents='box-none'>
          <Interactable.View
            ...
            initialPosition={{x: -140*widthFactor, y: -270*heightFactor}}>
              <TouchableOpacity style={[styles.button]} onPress={this.onPress.bind(this, 'Head1')}>
