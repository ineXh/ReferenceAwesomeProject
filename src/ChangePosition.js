    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{
          ...
          >
            <Text style={{color: 'blue', fontSize: 16}}>{"ChangePosition to " + JSON.stringify(blueDestination)}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
          ...
          >
            <Text style={{color: 'green', fontSize: 16}}>ChangePosition to random</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
